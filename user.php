...
<body>
    <div style="width: 100%;">
        <div id="product-grid" style="width: 50%; float: left; padding: 20px;">
            <ul><li class="allmenu"><a href="user.php">All Menu</a></li></ul>
            <ul>
                <li class="menu"><a class="active" href="user.php?view=v_acai">Acai</a></li>
                <li class="menu"><a href="user.php?view=v_blended">Blended</a></li>
                <li class="menu"><a href="user.php?view=v_coffee">Coffee</a></li>
                <li class="menu"><a href="user.php?view=v_others">Others</a></li>
                <li class="menu"><a href="user.php?view=v_pasta">Pasta</a></li>
                <li class="menu"><a href="user.php?view=v_rice">Rice</a></li>
                <li class="menu"><a href="user.php?view=v_sharedbites">Shared Bites</a></li>
                <li class="menu"><a href="user.php?view=v_sweet">Sweet</a></li>
                <li class="menu"><a href="user.php?view=v_tea">Tea</a></li>
                <li class="menu"><a href="user.php?view=v_topdrinks">Topping for Drinks</a></li>
                <li class="menu"><a href="user.php?view=v_topfood">Topping for Foods</a></li>
                <li class="menu"><a href="user.php?view=v_western">Western</a></li>
            </ul>
            <?php
                // include ("_con.php");
                // include '_con2.php';
            ...
            <div class="product-item" style="position: relative;">
                ...
                <div style="bottom: 5px; left: 20px; right: 20px; position: absolute; "><a style="margin: 20px" href="user.php?action=edit&product_id=<?php echo $product_array[$key]["product_id"]; ?>" class="btnRemoveAction">Edit</a><a href="delete.php?product_id=<?php echo $product_array[$key]["product_id"]; ?>" class="btnRemoveAction">Delete</a></div>
            </div>
            <?php
                }
            }
